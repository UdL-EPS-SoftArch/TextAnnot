...
export const routes: Routes = [
  ...
  { path: 'metadataValues', component: MetadataValueListComponent, anActivate: [LoggedInGuard] },
  { path: 'metadataValues/new', component: MetadataValueCreateComponent, anActivate: [LoggedInGuard]},
