...
export const routes: Routes = [
  ...
  {path: 'linguists/:id', component: LinguistDetailComponent, canActivate: [LoggedInGuard]},
  {path: 'linguists/:id/delete', component: LinguistDeleteComponent, canActivate: [AdministratorGuard]},
  {path: 'metadataValues/new', component: MetadataValueCreateComponent, canActivate: [AdministratorGuard]},
  {path: 'metadataValues', component: MetadataValueListComponent, canActivate: [LoggedInGuard]},
  {path: 'metadataValues/:id', component: MetadataValueDetailComponent, canActivate: [LoggedInGuard]},
  {path: 'metadataValues/:id/delete', component: MetadataValueDeleteComponent, canActivate: [AdministratorGuard]},
  {path: 'metadataValues/:id/edit', component: MetadataValueEditComponent, canActivate: [AdministratorGuard]},
